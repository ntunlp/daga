...
class DocumentRNNEmbeddings(DocumentEmbeddings):
    def __init__(
        ...
        # Canasai's comment out: rnn_type="GRU",
        rnn_type="LSTM",
        # Canasai's comment out: fine_tune: bool = True,
        ...
        if self.bidirectional:
            # Canasai's comment out: self.__embedding_length *= 4
    ...
    def _add_embeddings_internal(self, sentences: Union[List[Sentence], Sentence]):
        ...
        memory_bank, output_lengths = pad_packed_sequence(memory_bank, batch_first=True)
...
class CustomWordEmbeddings(WordEmbeddings):
    """Custom word embbeddings."""

    def __init__(
        self,
        embeddings: str,
        precomputed_word_embeddings: Word2VecKeyedVectors,
        field: str = None,
    ):
        self.embeddings = embeddings
        self.name: str = str(embeddings)
        self.static_embeddings = True
        self.precomputed_word_embeddings = precomputed_word_embeddings
        self.field = field
        self.__embedding_length: int = self.precomputed_word_embeddings.vector_size
        super(TokenEmbeddings, self).__init__()
