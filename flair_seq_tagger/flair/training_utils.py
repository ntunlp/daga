...
class WeightExtractor(object):
    # Canasai's comment out: def __init__(self, directory: Path, number_of_weights: int = 10):
    def __init__(
        self,
        directory: Path,
        number_of_weights: int = 10,
        file_name: str = "weights.txt",
    ):
        self.weights_file = init_output_file(directory, file_name)
